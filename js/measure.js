        ...
        handler.setInputAction(function (clickEvent) {
            ...
            if (positions.length == 0) {
                ...
                handler.setInputAction(function (moveEvent) {
                    var movePosition = viewer.camera.pickEllipsoid(
                    ...
                    if (positions.length == 2) {
                        ...
                        // 计算距离
                        var lengthText = "距離：" + getLengthText(positions[0], positions[1]);
    ...
    this.measureHeight = function () {
        ...
        handler.setInputAction(function (clickEvent) {
            ...
            if (viewer.scene.pickPositionSupported &&
                Cesium.defined(viewer.scene.pick(clickEvent.position))) {
                cartesian = viewer.scene.pickPosition(clickEvent.position); // 坐标
            } else {
                cartesian = viewer.camera.pickEllipsoid(
                    clickEvent.position, viewer.scene.globe.ellipsoid);
            }
            ...
            if (positions.length == 0) {
                ...
                handler.setInputAction(function (moveEvent) {
                    var movePosition;
                    if (viewer.scene.pickPositionSupported &&
                        Cesium.defined(viewer.scene.pick(moveEvent.endPosition))) {
                        movePosition = viewer.scene.pickPosition(moveEvent.endPosition); // 坐标
                    } else {
                        movePosition = viewer.camera.pickEllipsoid(
                            moveEvent.endPosition, viewer.scene.globe.ellipsoid);
                    }
                    ...
                    if (positions.length >= 2) {
                        ...
                        // 计算距离
                        var lengthText_1 = "水平距離：" + getLengthText(positions[0], positions[1]);
                        ...
                        // 计算距离
                        var lengthText_2 = "垂直距離：" + getLengthText(positions[1], positions[2]);
                        ...
                        // 计算距离
                        var lengthText_3 = "直線距離：" + getLengthText(positions[2], positions[3]);
